        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row">
                        @foreach($brand_by_id as $key => $bbi)
                        <div class="col-lg-4 col-md-6 col-sm-6">
                                <a id="wishlist_producturl{{$bbi->product_id}}" href="{{URL::to('/chi-tiet-san-pham/'.$bbi->product_id)}}">
                                <form>
                                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                                    <input type="hidden" class="cart_product_id_{{$bbi->product_id}}" value="{{$bbi->product_id}}">
                                    <input type="hidden" id="wishlist_productname{{$bbi->product_id}}" class="cart_product_name_{{$bbi->product_id}}" value="{{$bbi->product_name}}">
                                    <input type="hidden" class="cart_product_image_{{$bbi->product_id}}" value="{{$bbi->product_image}}">
                                    <input type="hidden" id="wishlist_productprice{{$bbi->product_id}}" class="cart_product_price_{{$bbi->product_id}}" value="{{$bbi->product_price}}">
                                    <input type="hidden" class="cart_product_quantity_{{$bbi->product_id}}" value="{{$bbi->product_quantity}}">
                                    <input type="hidden" class="cart_product_qty_{{$bbi->product_id}}" value="1">
                                </form>
                            <div class="product__item">
                                <div class="product__item__pic set-bg" style ="border:1px solid;border-radius: 3px;">
                                    <img id="wishlist_productimage{{$bbi->product_id}}" src="{{URL::to('uploads/product/'.$bbi->product_image)}}" alt="" />
                                ...
                                <div class="product__item__text">
                                    <h5><a href="{{URL::to('/chi-tiet-san-pham/'.$bbi->product_id)}}">{{$bbi->product_name}}</a></h5>
                                    <h5 style="color:red">{{number_format($bbi->product_price).' '.'VNĐ'}}</h5>
                                </div>
                                    <style>
                                    ...
                                    <button type="button" class="btn add-to-cart" name="add-to-cart" data-id_product="{{$bbi->product_id}}"
                                    ...
                                    <button class="btn btn-default button_wishlist" id="{{$bbi->product_id}}"
                                    ...
                                    class="btn btn-default xemnhanh" data-id_product="{{$bbi->product_id}}" 
                                    data-id_product="{{$bbi->product_id}}" name="" >Xem nhanh</button>
                            </div>
                            <a>
                        </div>
                        @endforeach
