                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <form>
                                    ...
                                    <input type="hidden" class="cart_product_id_{{$search_pro->product_id}}" value="{{$search_pro->product_id}}">
                                    <input type="hidden" id="wishlist_productname{{$search_pro->product_id}}" class="cart_product_name_{{$search_pro->product_id}}" value="{{$search_pro->product_name}}">
                                    <input type="hidden" class="cart_product_image_{{$search_pro->product_id}}" value="{{$search_pro->product_image}}">
                                    <input type="hidden" id="wishlist_productprice{{$search_pro->product_id}}" class="cart_product_price_{{$search_pro->product_id}}" value="{{$search_pro->product_price}}">
                                    <input type="hidden" class="cart_product_quantity_{{$search_pro->product_id}}" value="{{$search_pro->product_quantity}}">
                                    <input type="hidden" class="cart_product_qty_{{$search_pro->product_id}}" value="1">
                                </form>
                            <div class="product__item">
                                <div class="product__item__pic set-bg" style ="border:1px solid;border-radius: 3px;">
                                    <img id="wishlist_productimage{{$search_pro->product_id}}" src="{{URL::to('uploads/product/'.$search_pro->product_image)}}" alt="" />
                                ...
                                <div class="product__item__text">
                                    <h5><a href="{{URL::to('/chi-tiet-san-pham/'.$search_pro->product_id)}}">{{$search_pro->product_name}}</a></h5>
                                    <h5 style="color:red">{{number_format($search_pro->product_price).' '.'VNĐ'}}</h5>
                                </div>
                                    <style>
                                    ...
                                    <button type="button" class="btn add-to-cart" name="add-to-cart" data-id_product="{{$search_pro->product_id}}"
                                    ...
                                    <button class="btn btn-default button_wishlist" id="{{$search_pro->product_id}}"
                                    ...
                                    class="btn btn-default xemnhanh" data-id_product="{{$search_pro->product_id}}" 
                                    data-id_product="{{$search_pro->product_id}}" name="" >Xem nhanh</button>
                            </div>
                            <a>
                        </div>
                        @endforeach
